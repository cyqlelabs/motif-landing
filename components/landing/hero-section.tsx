      ...
      >
        ...
        >
          <WaitlistForm
            ...
            cta={t.hero.waitlist.cta}
            successText={t.hero.waitlist.success}
            successSub={t.hero.waitlist.successSub}
            errorText={t.hero.waitlist.error}
            className="mt-2 sm:mt-4 max-w-md"
          />
        </motion.div>
      </motion.div>
